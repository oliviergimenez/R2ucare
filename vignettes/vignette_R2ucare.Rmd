...
Let's begin by reading in the classical dipper using the `read.inp` function. Note that data with the Headed format can also be read using the function `read.headed`. The dataset is provided with the package (thanks to Gilbert Marzolin for sharing his data).
